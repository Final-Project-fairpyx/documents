...
TTC מול SP:\
שני האלגוריתמים שווים מבחינת סכום כולל של קורסים ובחירת הקורסים הגבוהים יותר ברשימה .\
...
ככל שWi גדל, זה אומר שהסטודנט חילק את הנקודות שלו לפי הערך המשותף(כמות הנקודות שהסטודנט חושב ש*אחרים* ישימו) ופחות לפי הערך האישי(כמו הנקודות ש*הסטודנט רוצה* לשים) כך שאם wi=0.5 זה אומר שהערך המשותף לא עניין אותו בכלל והוא שם נקודות בדיוק לפי הערך האישי(הסטודנט לא היה אסטרטג כלל).
...
ניתן לראות שככל שה-wi גדל (המעידה על השפעה אסטרטגית חזקה יותר), התועלת הממוצעת של תלמידים אסטרטגיים פוחתת בכל האלגוריתמים מלבד BPM.
...
לפי הגרף הנ"ל ניתן לראות שבאופן כללי באלגוריתם BPM  יש יתרון משמעותי למשחק אסטרטגי, שאר האלגוריתמים ובמיוחד הOC מראים שאין כ"כ השפעה על התנהגת אסטרטגית והטיפה השפעה אין לדעת אם תהיה לרעת או לטובת האסטרטג ולכן בשימוש באלגוריתם OC הממלצה היא לבחור קורסים ללא אסטרטגיות.
...
לסיכום:\
האלגוריתמם הכי פחות טוב - BPM. ולכן בהשוואה של שאר האלגוריתמים OC בולט כאלגוריתם הטוב ביותר אלא אם כן הצורך באלגוריתם שלא יתחשב באסטרטגיה עולה על הצורך בהוגנות ויעילות, נבחר בTTC-O או SP-O 
